...
- calibration:
	- [experimental_results.ipynb](calibration/experimental_results.ipynb): runs calibation on a small subset and plots the loss and the Smagorinsky constant across iterations,
	- [timings.ipynb](calibration/timings.ipynb): produce calibration timings,
	- [experimental_multi_gpus.ipynb](calibration/experimental_multi_gpus.ipynb): same as experimental_results.ipynb, but trying to use several GPUs.
