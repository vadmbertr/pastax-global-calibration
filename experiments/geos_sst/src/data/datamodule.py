...
class DataModule(L.LightningDataModule):
    def __init__(
        ...
        self.duacs = Duacs(data_root, start_datetime, end_datetime)
        self.mur = Mur(data_root, start_datetime, end_datetime)
    ...
    def prepare_data(self):
        self.hdf5_data.prepare_data(self.gdp, self.duacs, self.mur)
