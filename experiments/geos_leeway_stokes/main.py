...
ExperimentConfig = make_config(
    ...
    dynamics=builds(LinearDeterministic),
    module=pbuilds(DeterministicModule, integration_dt=30*60, learning_rate=1e-2),
...
if __name__ == "__main__":
    ...
    store(ExperimentConfig, name="geos_leeway_stokes")

    zen(do_calibrate).hydra_main(
        config_name="geos_leeway_stokes",
        version_base="1.1",
        config_path=".",
    )
